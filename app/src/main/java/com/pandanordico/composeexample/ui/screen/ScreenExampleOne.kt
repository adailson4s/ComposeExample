...
import com.pandanordico.composeexample.navigation.Routes.ScreenExampleTwo.toScreenExampleTwo
import com.pandanordico.composeexample.ui.theme.Dimen

@Composable
fun ScreenExampleOne(
    dimens: Dimen,
    ...
    Column(
        ...
        Button(
            onClick = { navController.toScreenExampleTwo() }
        ) {
